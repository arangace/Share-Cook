...
```
When you click on the button, if the button is active it will rain down confetti. Slight homage to when you submit an assignment on canvas. If the button is inactive, the confetti will disappear
```
